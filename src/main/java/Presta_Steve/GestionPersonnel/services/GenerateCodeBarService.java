...
public class GenerateCodeBarService {
    ...
    public void generateBarcodeToImage(String id) {
        try {
            ...
            // ✅ Données GS1-128 : sans parenthèses pour le code-barres
            String rawData = "01" + id; // ex: "0118456789010010"
            String humanReadable = "(01)" + id;
    
            int barcodeWidth = 400;
            int barcodeHeight = 100;
    
            // ✅ Générer le code-barres + texte en dessous
            BufferedImage barcodeImage = generateGS1BarcodeWithText(rawData, humanReadable, barcodeWidth, barcodeHeight);
            ...
            // ✅ Ajouter le code-barres avec fond blanc
            g.setColor(Color.WHITE);
            g.fillRect(positionX, positionY, barcodeImage.getWidth(), barcodeImage.getHeight());
            g.drawImage(barcodeImage, positionX, positionY, null);
            g.dispose();
    
            // ✅ Sauvegarder en PNG
            String outputFilePath = outputPath.endsWith(".png") ? outputPath : outputPath + ".png";
    ...
    private BufferedImage generateGS1BarcodeWithText(String rawData, String humanText, int width, int height) throws Exception {
        ...
        // Ajouter une zone pour le texte sous le code-barres
        ...
        int textWidth = fm.stringWidth(humanText);
        g.drawString(humanText, (width - textWidth) / 2, height + 20);
