...
public class JwtService {
  ...
  public JwtService(IUtilisateurService utilisateurService) {
    this.utilisateurService = utilisateurService;
  }
  //@Value("${secret_key}")
  private String cle = "0f174d9f413d7f535b46920d821229ee6ce367a2816aff53269dad1f42619da4";

  public Map<String, String> generateJwt(Utilisateurs utilisateur) {
    ...
    final String bearer = Jwts.builder()
        ...
        .setSubject(utilisateur.getEmail()) // Claim standard "sub"
        .claim("nom", utilisateur.getNom()) // Claim personnalisé
  ...
  public Map<String,String> generate(String email) {
    Utilisateurs utilisateur = this.utilisateurService.loadUserByUsername(email);
